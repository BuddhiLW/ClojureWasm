...
Both parts are a map of the territory as upstream left it, not a list of things
about to change: this fork inherited the divergences rather than choosing them.
Part 1 marks behaviour not to
